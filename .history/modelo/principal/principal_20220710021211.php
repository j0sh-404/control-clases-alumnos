...
$idModeloGrupo = isset($_POST["idModeloGrupo"])?$_POST["idModeloGrupo"]:"";
    ...
    case 'guardarClase':
        ...
        case 'guardarGrupo':
            ...
            case 'mostrarClases':
                ...
                case 'guardarAlumno':
                    $rspta=$principal->guardarAlumno($nombreAlumno,$apellidoAlumno,$correoAlumno,$rolAlumno,$clasesAlumno,$idModeloGrupo);
